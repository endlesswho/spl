...
DATASET_PATH = "/home/cmlkaist/Documents/spl/amass_test/AMASS_Amirsaman"
# Here we visualize a window of 180 frames from full-length test dataset in rotation matrix format.
DATA_PATH = os.path.join(DATASET_PATH, "rotmat", "test_dynamic", "amass-?????-of-?????")
META_DATA_PATH = os.path.join(DATASET_PATH, "rotmat", "training", "stats.npz")
SAVE_DIR = "/home/cmlkaist/Documents/spl/out"
...
for it in range(200):
    ...
    print(pose_name)
    if pose_name == "BioMotion/0/BioMotion/rub0170005_normal_walk1_dynamics":
        pose_seq = batch["inputs"].numpy()
        # Visualize skeleton.
        try:
